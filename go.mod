...
replace github.com/FloatTech/zbputils => github.com/QingFeng-awa/zbputils v1.9.1

replace github.com/FloatTech/AnimeAPI => github.com/QingFeng-awa/AnimeAPI v1.8.6
