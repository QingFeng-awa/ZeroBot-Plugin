...
var (
	...
	engine = control.AutoRegister(&ctrl.Options[*zero.Ctx]{
		...
		Help: "- 娶群友\n" +
			...
			"- <娶|嫁><@User>\n" +
			"好感度越高成功率越高，保底30%概率，娶成功好感度随机加1-5\n" +
			"- 闹离婚\n" +
			"好感度越高成功率越低\n" +
			"- 买[廉价|普通|昂贵|顶级]礼物给<@User|UserQQID>\n" +
			"礼物品质越高所需价格越高，接受概率、好感度增加也就越高，如果被拒绝好感度扣除也会更少\n" +
			"- 做媒<@User1><@User2>\n" +
		...
		Handle(func(ctx *zero.Ctx) {
			...
			case userInfo.User == uid: // 娶过别人
				ctx.SendChain(
					...
					message.Image("https://q4.qlogo.cn/g?b=qq&nk="+strconv.FormatInt(userInfo.Target, 10)+"&s=140").Add("cache", 0),
					message.Text(
						"\n",
						"[", userInfo.Targetname, "]",
						"(", userInfo.Target, ")哒",
			...
			case userInfo.Target == uid: // 嫁给别人
				ctx.SendChain(
					...
					message.Image("https://q4.qlogo.cn/g?b=qq&nk="+strconv.FormatInt(userInfo.User, 10)+"&s=140").Add("cache", 0),
					message.Text(
						"\n",
						"[", userInfo.Username, "]",
						"(", userInfo.User, ")娶了",
